// Package handler exposes the AI-gateway over Huma (code-first OpenAPI 3.1) on
// Fiber v3, following the trust/community shape: the house {code,message,data}
// envelope, Fiber-layer S2S auth bridged into the Huma context, and a Setup
// function cmd/gen-openapi can call with nil deps to export the spec.
package handler
