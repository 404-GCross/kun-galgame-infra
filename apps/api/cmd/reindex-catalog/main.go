// reindex-catalog (re)builds the catalog entity search indexes — credit names,
// characters, labels — from kun_catalog into Meilisearch, applying the doc-13
...
func main() {
	indexFlag := flag.String("index", "catalog_credit_names,catalog_characters,catalog_labels", "comma-separated index uids")
