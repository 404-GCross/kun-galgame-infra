...
export interface paths {
    ...
    "/api/v1/user/playtime/batch": {
        ...
        post: operations["reportPlaytimeBatch"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/user/playtime/by-ref/{source}/{externalID}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        put: operations["reportPlaytimeByRef"];
        post?: never;
        delete?: never;
        options?: never;
        head?: never;
    ...
    "/api/v1/user/playtime/mine": {
        ...
        get: operations["listOwnPlaytime"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/user/playtime/works/{workID}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get: operations["getOwnPlaytimeForWork"];
...
export interface components {
    schemas: {
        ...
        EnvelopePlaytimeBatchResponse: {
            /**
             * Format: uri
             * @description A URL to the JSON Schema for this object.
             * @example https://example.com/EnvelopePlaytimeBatchResponse.json
             */
            readonly $schema?: string;
            /** Format: int64 */
            code: number;
            data?: components["schemas"]["PlaytimeBatchResponse"];
            message: string;
        };
        EnvelopePlaytimeMineResponse: {
            /**
             * Format: uri
             * @description A URL to the JSON Schema for this object.
             * @example https://example.com/EnvelopePlaytimeMineResponse.json
             */
            readonly $schema?: string;
            /** Format: int64 */
            code: number;
            data?: components["schemas"]["PlaytimeMineResponse"];
            message: string;
        };
        EnvelopePlaytimeRecordResponse: {
            /**
             * Format: uri
             * @description A URL to the JSON Schema for this object.
             * @example https://example.com/EnvelopePlaytimeRecordResponse.json
             */
            readonly $schema?: string;
            /** Format: int64 */
            code: number;
            data?: components["schemas"]["PlaytimeRecordResponse"];
            message: string;
        };
        EnvelopePlaytimeSelfResponse: {
            /**
             * Format: uri
             * @description A URL to the JSON Schema for this object.
             * @example https://example.com/EnvelopePlaytimeSelfResponse.json
             */
            readonly $schema?: string;
            /** Format: int64 */
            code: number;
            data?: components["schemas"]["PlaytimeSelfResponse"];
            message: string;
        };
        ...
        PlaytimeBatchBody: {
             ...
             * Format: uri
             * @description A URL to the JSON Schema for this object.
             * @example https://example.com/PlaytimeBatchBody.json
             */
            readonly $schema?: string;
            /** @description Up to 200 reports. Each item is accepted or rejected on its own — a bad item never fails the batch */
            items: components["schemas"]["PlaytimeBatchItem"][] | null;
        };
        PlaytimeBatchItem: {
            /** @description The id this game carries on that source (e.g. v17, RJ01234) */
            external_id?: string;
            /**
             * Format: date-time
             * @description When this client last saw the game running (RFC 3339). Optional
             */
            last_played_at?: string;
            /**
             * Format: int64
             * @description Absolute cumulative playtime in MINUTES (never a delta)
             */
            minutes: number;
            /** @description External source key (vndb, dlsite, getchu, bangumi, …). Use WITH external_id when work_id is omitted */
            source?: string;
            /**
             * @description Defaults to playing
             * @enum {string}
             */
            status?: "playing" | "finished" | "dropped" | "on_hold";
            /**
             * Format: int64
             * @description Catalog work id. Omit to address by source/external_id instead
             */
            work_id?: number;
        };
        PlaytimeBatchResponse: {
            /** Format: int64 */
            accepted: number;
            /** Format: int64 */
            refused: number;
            results: components["schemas"]["PlaytimeBatchResult"][] | null;
        };
        PlaytimeBatchResult: {
            error?: string;
            /** Format: int64 */
        ...
        PlaytimeMineResponse: {
            cursor: string | null;
            items: components["schemas"]["PlaytimeRecordResponse"][] | null;
        };
        PlaytimeRecordResponse: {
            client_id: string;
        ...
        PlaytimeReportBody: {
             ...
             * Format: uri
             * @description A URL to the JSON Schema for this object.
             * @example https://example.com/PlaytimeReportBody.json
             */
            readonly $schema?: string;
            /**
             * Format: date-time
            ...
            /**
             * Format: int64
             * @description Absolute cumulative playtime in MINUTES (never a delta). Ceiling 60000 (1000 hours)
             */
            minutes: number;
            /**
             * @description Defaults to playing. ONLY finished reports feed the public aggregate
             * @enum {string}
             */
            status?: "playing" | "finished" | "dropped" | "on_hold";
        };
        PlaytimeSelfResponse: {
            /** Format: int64 */
            clients: number;
            last_played_at: string | null;
            /** Format: int64 */
...
export interface operations {
    ...
    reportPlaytimeBatch: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["PlaytimeBatchBody"];
            };
        };
        responses: {
            /** @description OK */
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["EnvelopePlaytimeBatchResponse"];
                };
            };
            /** @description Error */
            default: {
    ...
    reportPlaytimeByRef: {
        parameters: {
            ...
            header?: never;
            path: {
                /** @description External source key (vndb, dlsite, getchu, bangumi, …) */
                source: string;
                /** @description The id this game carries on that source (e.g. v17, RJ01234) */
                externalID: string;
            };
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["PlaytimeReportBody"];
            };
        };
        responses: {
            /** @description OK */
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["EnvelopePlaytimeRecordResponse"];
                };
            };
            /** @description Error */
            default: {
    ...
    listOwnPlaytime: {
        parameters: {
            query?: {
                /** @description RFC 3339 timestamp; returns only rows changed AFTER it. Omit for a full first pull */
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["EnvelopePlaytimeMineResponse"];
                };
            };
            /** @description Error */
            default: {
    ...
    getOwnPlaytimeForWork: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["EnvelopePlaytimeSelfResponse"];
                };
            };
            /** @description Error */
            default: {
