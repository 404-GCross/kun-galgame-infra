...
> **已过时** — 本文档在 galgame service 独立方案确定之前编写。
...
| Step | 端点数 | 复杂度 | 关键难点 |
|------|--------|--------|---------|
| 1. 基础 CRUD | 5 | 4/5 | 详情页 10+ 关联查询, 创建事务 |
| 2. 互动 | 3 | 2/5 | Toggle 模式 + count 维护 |
| 3. 评论 | 4 | 2/5 | 消息通知 |
| 4. 资源 | 8 | 3/5 | Provider 检测, 多关联表 |
| 5. PR | 6 | 5/5 | 最复杂: diff 存储, merge 逻辑 |
| 6. 链接 | 3 | 1/5 | 简单 CRUD |
| 7. 评分 | 9 | 3/5 | 8 维度评分, 萌萌点分级 |
| 8. 系列 | 7 | 2/5 | 标准 CRUD |
| 9. 元数据 | 12 | 2/5 | 搜索 + 别名管理 |
