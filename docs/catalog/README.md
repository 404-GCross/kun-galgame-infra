...
| # | 文件 | 内容 | 状态 |
|---|------|------|------|
| 01 | [service-and-contract.md](./01-service-and-contract.md) | 服务定位、registry/body 分界、S2S 三端点(resolve/redirects/claim)语义与 site 绑定、admin 三桶概述、**用户令牌写面(§4:封面投票 4.1 + 编辑提案三件套 4.2)**、鉴权形态、生成 spec、运维注记 | 已完成 |
